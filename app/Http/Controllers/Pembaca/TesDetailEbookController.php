...
class TesDetailEbookController extends Controller
{
    public function index($id)
    {
        ...
        return view('pembaca.tesdetailebook', compact('detailebook', 'ulasan', 'averageRating'));
    }
